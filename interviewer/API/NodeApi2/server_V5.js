...
app.get("/NITReports", async (req, res) => {
  try {
...
app.get("/fetchEnrollModules/:technologyId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
app.delete("/DeleteEnrollmentId", async (req, res) => {
  try {
...
app.get("/fetchFixedProgrammQuestions", async (req, res) => {
  try {
...
app.get("/retrive-batch-details/:batchId", async (req, res) => {
  try {
     ...
     *
     * value: {"technologyId":Number,"moduleId":Number,"batchName":String,"batchAdmin":String,"startDate":String,"endDate":String,"Ids":String,"mentorIds":String,"studentIds":String}
     */
...
app.post("/StudentProgramTestCases", async (req, res) => {
  try {
...
app.post("/RetriveProgramResults", async (req, res) => {
  try {
...
app.get("/FetchProgramsByTechnologies", async (req, res) => {
  try {
    console.info("List of  Programs");
    await sql.connect(sqlConfig);
...
app.get("/fetchProgramLanguages", async (req, res) => {
  try {
    console.info("List of Technolgies");
    await sql.connect(sqlConfig);
...
app.get("/fetch_StudentNames_StudentReportData", async (req, res) => {
  try {
...
app.get("/fetch_TechnologyName_StudentReportData", async (req, res) => {
  try {
...
app.get("/get_StudentReport_module", async (req, res) => {
  try {
    console.info("List of StudentNames");
    await sql.connect(sqlConfig);
    const { username, TestId, TechnologyName } = req.query;
    console.log(username, TestId, TechnologyName);
    if (!username) throw new Error("Invalid User");
...
app.get("/get_StudentReport_Topic", async (req, res) => {
  try {
    console.info("List of StudentNames1");
    await sql.connect(sqlConfig);
    console.info(req.query);
    const { username, topicname, TechnologyName } = req.query;
    console.log(username, topicname, TechnologyName);
    if (!username) throw new Error("Invalid User");
...
app.post("/InsertUpdateDelete_ProgramsQuestions", async (req, res) => {
  try {
    console.info("Method Insert Questions");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
app.get("/FetchTestcasesByProgramID", async (req, res) => {
  try {
...
app.post("/InsertUpdate_ProgramTestCases", async (req, res) => {
  try {
...
app.delete("/Delete_ProgramTestCases", async (req, res) => {
  try {
