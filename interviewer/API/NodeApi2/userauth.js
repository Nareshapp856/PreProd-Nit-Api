...
app.put("/api/nit_v1/Update_UserPassword", async (req, res) => {
  try {
    ...
    // Extract and validate userMail and updatedPassword from the request body
    const { userMail: UserName, updatedPassword: UserPassword } = req.body;
...
app.listen(4018, () => {
  console.log(`Server is running on port ${4018}`);
});
