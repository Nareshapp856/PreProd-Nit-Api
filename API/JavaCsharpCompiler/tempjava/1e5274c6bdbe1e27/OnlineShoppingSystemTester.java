...
public static void main(String[] args)
{
    ...
    E.displayInfo();
    System.out.println("---------------------------------");
    System.out.println("total cost is = " +E.calculateTotalCost(2));


  Clothing c=new Clothing("Tshirt",999,"puma","L"); 
  c.displayInfo();
   System.out.println("---------------------------------"); 
  System.out.println("total cost is =" +c.calculateTotalCost(2)); 
