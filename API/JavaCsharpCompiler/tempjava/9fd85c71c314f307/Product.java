public class Product{
    ...
    public void displayDetails(){
        System.out.println("Product Name : " + this.productName + ", Price : " + this.price + " , Quantity : " + this.quantity);
    }
    ...
    public void calculateDiscount(double discountPercentage){
        double newPrice = this.price - (this.price * (discountPercentage / 100.00));
        this.price = newPrice ;
    }
    public static void main(String[] args){
        ...
        System.out.println("\nDiscounted Price after 10% off : " + p1.price);
    }
}