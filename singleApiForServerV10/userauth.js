...
userAuthRouter.use(cors(corsOptions));
...
/*userAuthRouter.use(cors({ origin: 'https://www.nareshit.net' }));*/
//userAuthRouter.options('/execute', (req, res) => {
...
//userAuthRouter.use(Fingerprint());
...
userAuthRouter.post("/api/nit_v1/AuthenticateStudent", async (req, res) => {
  //   try {
...
userAuthRouter.post(
  "/api/nit_v1/AuthincateUser&SendOtp_V1",
  async (req, res) => {
...
userAuthRouter.put("/api/nit_v1/Update_UserPassword", async (req, res) => {
  try {
...
userAuthRouter.post("/api/nit_v1/User_OtpVerification", async (req, res) => {
  try {
...
userAuthRouter.put("/api/nit_v1/Update_UserLogoutTime", async (req, res) => {
  try {
