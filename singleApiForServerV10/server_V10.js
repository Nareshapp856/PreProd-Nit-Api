...
const {
  getTestcases,
  getProgramDetails,
} = require("../API/NodeApi2/constants/data");
...
//router.use(browserCheckMiddleware);
...
/*router.use(cors({ origin: 'https://www.nareshit.net' }));*/
...
router.post("/apinit/execute", (req, res) => {
  try {
    const { code } = req.body;
...
router.get("/apinit/register-2fa", async (req, res) => {
...
router.get("/apinit/register", (req, res) => {
  res.render("register"); // Assuming you have a register.ejs file
});
router.post("/apinit/login", async (req, res) => {
...
router.post("/apinit/register", async (req, res) => {
...
router.get("/apinit/checkUserAvailability", async (req, res) => {
  try {
...
router.post("/apinit/verify-2fa", (req, res) => {
...
router.get("/apinit/favicon.ico", (req, res) => res.status(204));
...
//});
router.post("/apinit/testcreatortypes", async (req, res) => {
  try {
...
router.get("/apinit/AdminHomePage", (req, res) => {
  res.render("AdminHomePage", { username: req.query.username });
});

router.get("/apinit/testSelection", (req, res) => {
  res.render("TestSelection", {
    /* Add any variables you want to pass to the view */
  });
});

router.get("/apinit/testcreator", (req, res) => {
  res.render("testcreator", {
    /* Add any variables you want to pass to the view */
  });
});

router.get("/apinit/testcreatortypes", (req, res) => {
...
router.get("/apinit/page2", (req, res) => {
  res.render("Page2", {
    /* Add any variables you want to pass to the view */
  });
});
...
router.post("/apinit/assessment", (req, res) => {
...
router.get("/apinit/exam", async (req, res) => {
...
router.get("/apinit/testCreationPage", (req, res) => {
  res.render("testCreationPage");
});
router.get("/apinit/quesitontreeview", async (req, res) => {
  try {
...
router.get("/apinit/questionSelection", (req, res) => {
...
//router.get('/fetchTechnologies', async (req, res) => {
//    try {
...
router.get("/apinit/fetchTechnologies", async (req, res) => {
  try {
...
//router.get('/fetchModules/:technologyId', async (req, res) => {
...
//router.get('/fetchTopics/:moduleId', async (req, res) => {
...
router.get("/apinit/fetchTopics/:moduleId", async (req, res) => {
  try {
...
//router.get('/fetchSubtopics/:topicId', async (req, res) => {
...
router.get("/apinit/fetchSubtopics/:topicId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/apinit/fetchModules/:technologyId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/apinit/getModulesByTechnologyIdForBatch", async (req, res) => {
  try {
    ...
    if (!technologyId) {
      return res
        .status(400)
        .json({ success: false, message: "technology is required" });
    }

    // Execute the stored procedure and get results
    const result =
      await sql.query`EXEC [dbo].[USP_Get_ModuleIdByTechnologies_v2] @technologyId=${technologyId}`;
...
router.get("/apinit/fetchEnrollModules/:technologyId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/apinit/getQuestionCounts/:questionTypeId", async (req, res) => {
  try {
    const testId = 1;
...
router.get("/apinit/getAllTests", async (req, res) => {
  try {
    await sql.connect(sqlConfig);
    const result = await sql.query(`
...
router.get("/apinit/mcqQuestions", async (req, res) => {
  try {
...
router.post("/apinit/InsertionQuestionView", async (req, res) => {
  try {
...
router.post("/apinit/Listof_BatchDetails", async (req, res) => {
  try {
...
router.post("/apinit/CreateNewEnrollId", async (req, res) => {
  try {
...
router.post("/apinit/Listof_AvailableTests", async (req, res) => {
  try {
...
router.post("/apinit/Fetch_StudentEmail", async (req, res) => {
  try {
...
router.post("/apinit/FetchTechnologyBy_Email", async (req, res) => {
  try {
    console.info("Method CheckEmail");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/GetBatchesByTestId", async (req, res) => {
  try {
...
router.post("/apinit/GetStudentNameByBatchId", async (req, res) => {
  try {
...
router.post("/apinit/Retrive_SlotDetails", async (req, res) => {
  try {
...
router.post("/apinit/Retrive_SlotDetails_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
// router.post("/apinit/Update_BookSlot", async (req, res) => {
//   try {
//     console.info("Method listofSlots");
//     await sql.connect(sqlConfig);
//     console.log(req.body);
...
router.post("/apinit/Update_BookSlot_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/UserLogin_send-otp", async (req, res) => {
...
router.post("/apinit/EnrollStudents", async (req, res) => {
  try {
...
router.post("/apinit/GetBatchIdsByTestids", async (req, res) => {
  try {
...
router.post("/apinit/EnrollTest", async (req, res) => {
  try {
...
router.delete("/apinit/DeleteEnrollmentId", async (req, res) => {
  try {
...
router.post("/apinit/Retrive_Enroll", async (req, res) => {
  try {
...
router.post("/apinit/Fetch_Batches", async (req, res) => {
  try {
    console.info("Method ListofBatches");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/Fetch_Students", async (req, res) => {
  try {
...
router.get("/validateStudentEmail", async (req, res) => {
  try {
    console.log("Student Email Validate API");
    ...
    const result = await sql.query`
      EXEC [dbo].[ValidateStudentEmail] @Email = ${email}`;
...
router.get("/validateStudentPhone", async (req, res) => {
  try {
    console.log("Student Email Validate API");
    ...
    if (!phoneNumber) {
      return res
        .status(400)
        .send({ error: "phoneNumber parameter is required" });
    }
    ...
    console.log("query executing");
    const result = await sql.query`
      EXEC [dbo].[ValidateStudentPhone] @PhoneNumber = ${phoneNumber}`;
...
router.put("/apinit/updateStudentDetails", async (req, res) => {
  try {
...
router.post("/apinit/Create_StudentsBatchs", async (req, res) => {
  try {
...
router.post("/apinit/Create_StudentBatch", async (req, res) => {
  try {
    ...
    const { technologyId, batchName, batchAdmin, start_Date, end_Date } =
      req.body;

    // Validate required fields
    if (!technologyId || !batchName || !start_Date) {
      return res.status(400).json({
        success: false,
        message:
          "Missing required fields: technologyId, batchName, or start_Date.",
      });
    }

    // Execute the stored procedure
    const result = await sql.query`EXEC [dbo].[Usp_Create_StudentBatch] 
        @TechnologyId=${technologyId}, 
        @BatchName=${batchName}, 
    ...
    if (result.recordset && result.recordset.length > 0) {
      ...
      res.status(200).json({
        success: true,
        message: "Batch operation executed successfully, but no data returned.",
        dbresult: null,
      });
    }
  } catch (err) {
    ...
    res.status(500).json({
      success: false,
      message: "Error executing stored procedure.",
      apperror: err.message, // Only return the error message, not the full object
    });
  } finally {
...
router.post("/apinit/addStudentsBatch", async (req, res) => {
  try {
    ...
    // Create a TVP from the Students array
    const tvp = new sql.Table("TVP_Students2");
    tvp.columns.add("FirstName", sql.VarChar(100));
    tvp.columns.add("LastName", sql.VarChar(100));
    tvp.columns.add("Email", sql.VarChar(100));
    tvp.columns.add("PhoneNumber", sql.VarChar(100));
    tvp.columns.add("BatchId", sql.BigInt); // Include BatchId in the TVP
...
router.post("/apinit/Get_Facaulty", async (req, res) => {
  try {
...
router.post("/apinit/Get_Mentors", async (req, res) => {
  try {
    console.info("Method Listof_Facaulty");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/ListofStudents", async (req, res) => {
  try {
    console.info("Method listofStudents");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/CreateDynamicTest", async (req, res) => {
  try {
...
router.post("/apinit/Insert_Update_QuestionCombination", async (req, res) => {
  try {
...
router.post("/apinit/Insertion_StudentProgramDeatils", async (req, res) => {
  try {
    console.info("Method Listof_Facaulty");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/SelectQuestionCombination", async (req, res) => {
  try {
...
router.post("/apinit/FetchAvailableQuestionsByCount", async (req, res) => {
  try {
...
router.post("/apinit/Final_Preview", async (req, res) => {
  try {
...
router.post("/apinit/SelectAllFixedQuestions", async (req, res) => {
  try {
...
router.post("/apinit/RetriveTestSchedule", async (req, res) => {
  try {
...
router.post("/apinit/LoadStudentData", async (req, res) => {
  try {
...
router.post("/apinit/CreateTechnology", async (req, res) => {
  try {
...
router.put("/apinit/UpdateTechnology", async (req, res) => {
  try {
...
router.post("/apinit/GetTechnologyID", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/apinit/DeleteTechnology", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/apinit/SelectAll_Technologies", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/apinit/SelectValuesBy_TechnologyID", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/apinit/GetTechnologies", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    //console.log(req.body);
...
router.post("/apinit/CreateModules", async (req, res) => {
  try {
...
router.put("/apinit/Update_Module", async (req, res) => {
  try {
...
router.delete("/apinit/Delete_Module", async (req, res) => {
  try {
    console.info("Method entered for update Module");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/CreateTopics", async (req, res) => {
  try {
...
router.post("/apinit/CreateSubTopic", async (req, res) => {
  try {
...
router.post("/apinit/CreateMCQquestions", async (req, res) => {
  try {
...
router.post("/apinit/FinalSubmission", async (req, res) => {
  try {
...
router.post("/StudentFinalSubmission", async (req, res) => {
  submissionQueue.push({ req, res });
  processQueue();
});

router.post("/StudentFinalSubmission_Preview", async (req, res) => {
  try {
...
router.post("/getStudentExamSubmission", async (req, res) => {
  try {
...
router.post("/apinit/RefreshSubmission", async (req, res) => {
  try {
    // Extract data from the request body
    const resultData = req.body.resultData;
    const studentName = req.body.studentName;
...
router.post("/apinit/getCurrentQuestionId", async (req, res) => {
  try {
...
router.post("/apinit/UpdateCombinations", async (req, res) => {
  try {
...
router.put("/apinit/updateCurrentQuestionId", async (req, res) => {
  try {
...
async function callFinalExamSubmissionProcedure(
  ...
  try {
    ...
    table.columns.add("Answer", sql.NVarChar(10000));
...
async function callStudentFinalExamSubmissionProcedure_Preview(
  ...
  try {
    ...
    const table = new sql.Table();
    table.columns.add("QuestionID", sql.Int);
    table.columns.add("Answer", sql.NVarChar(15000));
    table.columns.add("Status", sql.NVarChar(50));
    table.columns.add("Type", sql.NVarChar(50));
...
router.post("/apinit/createEditTest", async (req, res) => {
  try {
...
router.post("/apinit/getBasicTestInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
...
router.post("/apinit/getBasicTestDetailsInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
    const result = await pool.request();
...
router.post("/apinit/updateTest", async (req, res) => {
  try {
...
router.post("/apinit/createTestAssessment", async (req, res) => {
  try {
    console.log(req.body.data);
    const pool = await sql.connect(sqlConfig);
    const result = await pool
...
router.post("/apinit/CreateTestQuestions", async (req, res) => {
  try {
    const table = new sql.Table();
...
router.post("/apinit/insertQuestionData", async (req, res) => {
  try {
    ...
    tableType.columns.add("CorrectAnswer", sql.NVarChar(max));
...
router.post("/apinit/FastTrackCreateTest", async (req, res) => {
  try {
    const questionData = req.body;
...
router.get("/apinit/fetchFixedQuestions", async (req, res) => {
  try {
...
router.get("/apinit/fetchFixedProgrammQuestions", async (req, res) => {
  try {
...
router.get("/apinit/retrieveProgramQuestions/:id", async (req, res) => {
  try {
...
router.post("/GetTodayTests_code", async (req, res) => {
  try {
    ...
    const result = await sql.query`EXEC [dbo].[USP_GetTodayTests_Code]
...
router.get("/apinit/retrieveProgramTestCase/:id", async (req, res) => {
  try {
...
router.get("/apinit/mcqCheckQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
...
router.get("/apinit/FreeTextQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
    const { easyCount, mediumCount, hardCount } = req.query;
...
router.get("/apinit/fetchtestsbydate", async (req, res) => {
  try {
...
router.get("/apinit/getimage/:username", async (req, res) => {
  try {
    await sql.connect(sqlConfig);
    const result = await sql.query`
      SELECT
...
router.get("/apinit/studentExamPage", async (req, res) => {
...
router.get("/apinit/previewExamPage", async (req, res) => {
...
router.get("/MCQExamPage", async (req, res) => {
  const testID = req.query.testID; // Extract testID from query string
  const transactionId = req.query.transactionId;
  const userName = req.query.UserName;
...
router.get("/MCQExamPagePreview", async (req, res) => {
...
router.post("/apinit/AuthenticateAdmin", async (req, res) => {
  try {
    console.info("Method CheckUsername");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/RetriveTestsBystudentId_code", async (req, res) => {
  try {
...
router.post("/apinit/RetriveProgramQuestionsByTestid", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
...
router.post("/apinit/RetriveProgramsByStudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/RetriveTestsBystudentId_Mcq", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/apinit/retrive-batch-details/:batchId", async (req, res) => {
  try {
...
router.post("/apinit/program/new-program", (req, res) => {
  try {
    const body = req.body;
...
router.get("/apinit/ExamMainPage", async (req, res) => {
  const testID = req.query.testID; // Extract testID from query string
  const transactionId = req.query.transactionId;
  const userName = req.query.UserName;
...
router.get("/apinit/studentexampagev1", async (req, res) => {
...
router.get("/apinit/studentExamPagemodified", async (req, res) => {
...
router.get("/apinit/login", async (req, res) => {
...
//router.get('/studentResultPage', async (req, res) => {
...
router.post("/apinit/StudentProgramTestCases", async (req, res) => {
  try {
...
router.post("/apinit/RetriveTestsBystudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/apinit/RetriveProgramResults", async (req, res) => {
  try {
...
router.get("/apinit/studentResultPageview", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
router.get("/apinit/fetchAndShowResults", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
router.get("/apinit/FetchProgramsByTechnologies", async (req, res) => {
  try {
    console.info("List of  Programs");
    await sql.connect(sqlConfig);
...
// });
router.post("/apinit/executeonline", async (req, res) => {
...
router.get("/apinit/fetchProgramLanguages", async (req, res) => {
  try {
    console.info("List of Technolgies");
    await sql.connect(sqlConfig);
...
router.get("/apinit/fetch_StudentNames_StudentReportData", async (req, res) => {
  try {
...
router.get("/get_StudentReport/:username", async (req, res) => {
  try {
    console.info("List of StudentNames");
    await sql.connect(sqlConfig);
...
router.get("/studentReport_Technology", async (req, res) => {
  try {
    console.info("List of StudentNames");
    await sql.connect(sqlConfig);
    const {
...
router.get("/get_StudentReport_module", async (req, res) => {
  try {
...
router.get("/get_StudentReport_Topic", async (req, res) => {
  try {
...
router.get("/apinit/FetchTestcasesByProgramID", async (req, res) => {
  try {
...
router.post("/apinit/InsertUpdate_ProgramTestCases", async (req, res) => {
  try {
...
router.get("/apinit/fetchBatchesByMentorId", async (req, res) => {
  try {
    ...
    // Execute the stored procedure
    const result =
      await sql.query`EXEC [dbo].[Usp_FetchBatchDetailsByMentorId] @mentorId=${mentorId}`;
    ...
    if (result.recordset && result.recordset.length > 0) {
      ...
      return res.status(200).json({
        success: true,
        message: "No batches found for the given mentorId.",
        data: [],
      });
    }
  } catch (err) {
    ...
    // Close the SQL connection if necessary
    try {
      await sql.close();
    } catch (closeError) {
...
router.delete("/apinit/Delete_ProgramTestCases", async (req, res) => {
  try {
...
// router.get("/getcurriculamdetails", async (req, res) => {
...
router.post("/insertfacultycurriculam", async (req, res) => {
  const {
    facultyId,
...
router.get("/apinit/studentAssessmentData", async (req, res) => {
  try {
    const questionTypeId = req.params.questionTypeId;
...
router.post("/api/insertUpdateStudentWeeklyCalender", async (req, res) => {
  try {
    ...
    const result =
      await sql.query`EXEC Usp_InsertUpdateStudentWeeklyCalender @testid=${testid},
        @transactionId=${transactionId},@testDescription=${testDescription},@testStartDate=${testStartDate},@testEndDate=${testEndDate},@testStartTime=${testStartTime},@testEndTime=${testEndTime},@testEnabled=${testEnabled},@ExamType=${ExamType},
        @examSubmitted=${examSubmitted},@testCaseId=${testCaseId},@BatchId=${BatchId}`;
    if (result.recordset !== undefined && result.recordset.length > 0) {
      const recordsetData = result.recordset;
      res.status(200).json(recordsetData);
    } else {
...
router.get("/api/retriveStudentCalenderByStudentId", async (req, res) => {
  try {
...
router.get("/api/retrieveAvailableSlots", async (req, res) => {
  try {
...
// Angular-Vlabs API
router.post("/api/vlabs/insertstudents", async (req, res) => {
  ...
  try {
    const pool = await sql.connect(sqlConfig); // Get database connection
    const request = pool.request(); // Create a new request

    // Adding input parameters for the stored procedure
    request.input("FirstName", sql.VarChar, FirstName);
    request.input("LastName", sql.VarChar, LastName);
    request.input("Email", sql.VarChar, Email);
    request.input("PhoneNumber", sql.VarChar, PhoneNumber);
    request.input("TechnologyName", sql.VarChar, TechnologyName);
    request.input("Password", sql.VarChar, Password);

    // Add output parameter for the message
    request.output("message", sql.VarChar);

    // Execute the stored procedure
    const result = await request.execute("[dbo].[AddStudentWithTechnology]");

    // Extract the message from output
    const message = result.output?.message;

    // Handle specific error messages based on the output message
    if (message) {
