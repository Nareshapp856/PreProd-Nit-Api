...
const serverV9router = express.Router();
const {
  startOfYear,
  addWeeks,
  getMonth,
...
const {
  getTestcases,
  getProgramDetails,
} = require("./RBAC-interviewer/constants/data");
...
const browserCheckMiddleware = (req, res, next) => {
  // List of common browser User-Agent strings (you can expand this list)
  const browserUserAgents = [
    "Mozilla/", // Common prefix for most browsers
  ...
  // Check if the User-Agent includes any of the common browser strings
  const isBrowserRequest = browserUserAgents.some(
    (ua) => userAgent && userAgent.includes(ua)
  );

  // Optionally, check for referer/origin headers
  const hasValidReferer = referer && referer.startsWith("http");
  const hasValidOrigin = origin && origin.startsWith("http");

  // Allow only if it's a browser request and has valid referer/origin
  if (!isBrowserRequest || !(hasValidReferer || hasValidOrigin)) {
...
// serverV9router.use(cors(corsOptions));
serverV9router.use(cors());
//serverV9router.use(browserCheckMiddleware);
...
serverV9router.use(bodyParser.json());
/*serverV9router.use(cors({ origin: 'https://www.nareshit.net' }));*/
//serverV9router.options('/execute', (req, res) => {
//    res.setHeader('Access-Control-Allow-Origin', 'https://www.nareshit.net');
//    res.setHeader('Access-Control-Allow-Methods', 'OPTIONS, POST');
//    res.setHeader('Access-Control-Allow-Headers', 'Content-Type');
//    res.sendStatus(200);
//});
serverV9router.use(express.json());
//serverV9router.use(Fingerprint());
//serverV9router.use((req, res, next) => {
//    res.setHeader('Access-Control-Allow-Origin', 'https://www.nareshit.net');
//    res.setHeader('Access-Control-Allow-Methods', 'OPTIONS, POST');
//    res.setHeader('Access-Control-Allow-Headers', 'Content-Type');
//    next();
...
serverV9router.post("/apinit/execute", (req, res) => {
  try {
    const { code } = req.body;
...
serverV9router.get("/apinit/register-2fa", async (req, res) => {
...
serverV9router.get("/apinit/register", (req, res) => {
  res.render("register"); // Assuming you have a register.ejs file
});
serverV9router.post("/apinit/login", async (req, res) => {
...
serverV9router.post("/apinit/register", async (req, res) => {
...
serverV9router.get("/apinit/checkUserAvailability", async (req, res) => {
  try {
...
serverV9router.post("/apinit/verify-2fa", (req, res) => {
...
//serverV9router.get('/', (req, res) => {
//    const deviceId = req.fingerprint.hash;
//    res.send(`Device ID: ${deviceId}`);
//});
// Middleware
serverV9router.use(express.static(path.join(__dirname, "/")));

serverV9router.use(compression());
serverV9router.use(bodyParser.json());
serverV9router.use(bodyParser.urlencoded({ extended: true }));
// Serve images from the /Images route

// Route for the specific image

serverV9router.get("/apinit/favicon.ico", (req, res) => res.status(204));

// Set the view engine to EJS and specify the views directory
// serverV9router.set("view engine", "ejs");
// serverV9router.set("views", path.join(__dirname, "views"));
...
//});
serverV9router.post("/apinit/testcreatortypes", async (req, res) => {
  try {
...
serverV9router.get("/apinit/AdminHomePage", (req, res) => {
  res.render("AdminHomePage", { username: req.query.username });
});

serverV9router.get("/apinit/testSelection", (req, res) => {
  res.render("TestSelection", {
    /* Add any variables you want to pass to the view */
  });
});

serverV9router.get("/apinit/testcreator", (req, res) => {
  res.render("testcreator", {
    /* Add any variables you want to pass to the view */
  });
});

serverV9router.get("/apinit/testcreatortypes", (req, res) => {
...
serverV9router.get("/apinit/page2", (req, res) => {
  res.render("Page2", {
    /* Add any variables you want to pass to the view */
  });
});
...
serverV9router.post("/apinit/assessment", (req, res) => {
...
serverV9router.get("/apinit/assessment", (req, res) => {
  res.render("assessment");
});

serverV9router.get("/studentResultPage", (req, res) => {
  res.render("studentResultPage"); // Check if the route handler matches the view name
});

serverV9router.get("/apinit/RetriveResultPage", (req, res) => {
  res.render("RetriveResultPage"); // Check if the route handler matches the view name
});

serverV9router.get("/apinit/enrollStudent", (req, res) => {
...
serverV9router.get("/apinit/exam", async (req, res) => {
...
serverV9router.get("/apinit/testCreationPage", (req, res) => {
  res.render("testCreationPage");
});
serverV9router.get("/apinit/quesitontreeview", async (req, res) => {
  try {
...
//quesitontreeview
//serverV9router.get('/quesitontreeview', (req, res) => {
//    res.render('quesitontreeview');
//});

// Route for processing the test creation form submission
serverV9router.post("/apinit/createTest", async (req, res) => {
  try {
...
serverV9router.get("/apinit/questionSelection", (req, res) => {
...
//serverV9router.get('/fetchTechnologies', async (req, res) => {
//    try {
...
//    }
//});
//serverV9router.get('/treeview', async (req, res) => {
//    try {
...
serverV9router.get("/apinit/fetchTechnologies", async (req, res) => {
  try {
...
//serverV9router.get('/fetchModules/:technologyId', async (req, res) => {
...
//serverV9router.get('/fetchTopics/:moduleId', async (req, res) => {
...
serverV9router.get("/apinit/fetchTopics/:moduleId", async (req, res) => {
  try {
...
//serverV9router.get('/fetchSubtopics/:topicId', async (req, res) => {
...
serverV9router.get("/apinit/fetchSubtopics/:topicId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.get("/apinit/fetchModules/:technologyId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.get(
  "/apinit/fetchEnrollModules/:technologyId",
  async (req, res) => {
    try {
      console.info("List of  Technologies");
      await sql.connect(sqlConfig);
...
serverV9router.get(
  "/apinit/getQuestionCounts/:questionTypeId",
  async (req, res) => {
    try {
      const testId = 1;
...
serverV9router.get("/apinit/getAllTests", async (req, res) => {
  try {
    await sql.connect(sqlConfig);
    const result = await sql.query(`
...
serverV9router.get("/apinit/mcqQuestions", async (req, res) => {
  try {
...
serverV9router.post("/apinit/InsertionQuestionView", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Listof_BatchDetails", async (req, res) => {
  try {
...
serverV9router.post("/apinit/CreateNewEnrollId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Listof_AvailableTests", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Fetch_StudentEmail", async (req, res) => {
  try {
...
serverV9router.post("/apinit/FetchTechnologyBy_Email", async (req, res) => {
  try {
    console.info("Method CheckEmail");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/GetBatchesByTestId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/GetStudentNameByBatchId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Retrive_SlotDetails", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Retrive_SlotDetails_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
// serverV9router.post("/apinit/Update_BookSlot", async (req, res) => {
//   try {
//     console.info("Method listofSlots");
//     await sql.connect(sqlConfig);
//     console.log(req.body);
...
serverV9router.post("/apinit/Update_BookSlot_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/UserLogin_send-otp", async (req, res) => {
...
serverV9router.post("/apinit/EnrollStudents", async (req, res) => {
  try {
...
serverV9router.post("/apinit/GetBatchIdsByTestids", async (req, res) => {
  try {
...
serverV9router.post("/apinit/EnrollTest", async (req, res) => {
  try {
...
serverV9router.delete("/apinit/DeleteEnrollmentId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Retrive_Enroll", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Fetch_Batches", async (req, res) => {
  try {
    console.info("Method ListofBatches");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/Fetch_Students", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Create_StudentsBatchs", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Get_Facaulty", async (req, res) => {
  try {
...
serverV9router.post("/apinit/Get_Mentors", async (req, res) => {
  try {
    console.info("Method Listof_Facaulty");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/ListofStudents", async (req, res) => {
  try {
    console.info("Method listofStudents");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/CreateDynamicTest", async (req, res) => {
  try {
...
serverV9router.post(
  "/apinit/Insert_Update_QuestionCombination",
  async (req, res) => {
    try {
...
serverV9router.post(
  "/apinit/Insertion_StudentProgramDeatils",
  async (req, res) => {
    try {
      console.info("Method Listof_Facaulty");
      await sql.connect(sqlConfig);
...
serverV9router.post("/apinit/SelectQuestionCombination", async (req, res) => {
  try {
...
serverV9router.post(
  "/apinit/FetchAvailableQuestionsByCount",
  async (req, res) => {
    try {
...
serverV9router.post("/apinit/Final_Preview", async (req, res) => {
  try {
...
serverV9router.post("/apinit/SelectAllFixedQuestions", async (req, res) => {
  try {
...
serverV9router.post("/apinit/RetriveTestSchedule", async (req, res) => {
  try {
...
serverV9router.post("/apinit/LoadStudentData", async (req, res) => {
  try {
...
serverV9router.post("/apinit/CreateTechnology", async (req, res) => {
  try {
...
serverV9router.put("/apinit/UpdateTechnology", async (req, res) => {
  try {
...
serverV9router.post("/apinit/GetTechnologyID", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.delete("/apinit/DeleteTechnology", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.delete("/apinit/SelectAll_Technologies", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.delete(
  "/apinit/SelectValuesBy_TechnologyID",
  async (req, res) => {
    try {
      console.info("Method entered for update technology");
      await sql.connect(sqlConfig);
...
serverV9router.get("/apinit/GetTechnologies", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    //console.log(req.body);
...
serverV9router.post("/apinit/CreateModules", async (req, res) => {
  try {
...
serverV9router.put("/apinit/Update_Module", async (req, res) => {
  try {
...
serverV9router.delete("/apinit/Delete_Module", async (req, res) => {
  try {
    console.info("Method entered for update Module");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/CreateTopics", async (req, res) => {
  try {
...
serverV9router.post("/apinit/CreateSubTopic", async (req, res) => {
  try {
...
serverV9router.post("/apinit/CreateMCQquestions", async (req, res) => {
  try {
...
serverV9router.post("/startExam", async (req, res) => {
  try {
    if (isProcessing) {
...
serverV9router.post("/apinit/FinalSubmission", async (req, res) => {
  try {
...
serverV9router.post("/StudentFinalSubmission", async (req, res) => {
  submissionQueue.push({ req, res });
  processQueue();
});

serverV9router.post("/StudentFinalSubmission_Preview", async (req, res) => {
  try {
...
serverV9router.post("/getStudentExamSubmission", async (req, res) => {
  try {
...
serverV9router.post("/apinit/RefreshSubmission", async (req, res) => {
  try {
    // Extract data from the request body
    const resultData = req.body.resultData;
    const studentName = req.body.studentName;
...
serverV9router.post("/apinit/getCurrentQuestionId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/UpdateCombinations", async (req, res) => {
  try {
...
serverV9router.put("/apinit/updateCurrentQuestionId", async (req, res) => {
  try {
...
serverV9router.post("/apinit/createEditTest", async (req, res) => {
  try {
...
serverV9router.post("/apinit/getBasicTestInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
...
serverV9router.post("/apinit/getBasicTestDetailsInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
    const result = await pool.request();
...
serverV9router.post("/apinit/updateTest", async (req, res) => {
  try {
...
serverV9router.post("/apinit/createTestAssessment", async (req, res) => {
  try {
    console.log(req.body.data);
    const pool = await sql.connect(sqlConfig);
    const result = await pool
...
serverV9router.post("/apinit/CreateTestQuestions", async (req, res) => {
  try {
    const table = new sql.Table();
...
serverV9router.post("/apinit/insertQuestionData", async (req, res) => {
  try {
...
serverV9router.post("/apinit/FastTrackCreateTest", async (req, res) => {
  try {
    const questionData = req.body;
...
serverV9router.get("/apinit/fetchFixedQuestions", async (req, res) => {
  try {
...
serverV9router.get("/apinit/fetchFixedProgrammQuestions", async (req, res) => {
  try {
...
serverV9router.get("/apinit/retrieveProgramQuestions/:id", async (req, res) => {
  try {
...
serverV9router.post("/GetTodayTests_code", async (req, res) => {
  try {
...
serverV9router.get("/apinit/retrieveProgramTestCase/:id", async (req, res) => {
  try {
...
serverV9router.get("/apinit/mcqCheckQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
...
serverV9router.get("/apinit/FreeTextQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
    const { easyCount, mediumCount, hardCount } = req.query;
...
serverV9router.get("/apinit/fetchtestsbydate", async (req, res) => {
  try {
...
serverV9router.get("/apinit/getimage/:username", async (req, res) => {
  try {
    await sql.connect(sqlConfig);
    const result = await sql.query`
      SELECT
...
serverV9router.get("/apinit/studentExamPage", async (req, res) => {
...
serverV9router.get("/apinit/previewExamPage", async (req, res) => {
...
serverV9router.get("/MCQExamPage", async (req, res) => {
  const testID = req.query.testID; // Extract testID from query string
  const transactionId = req.query.transactionId;
  const userName = req.query.UserName;
...
serverV9router.get("/MCQExamPagePreview", async (req, res) => {
...
serverV9router.post("/AuthenticateStudent", async (req, res) => {
  try {
...
serverV9router.post("/apinit/AuthenticateAdmin", async (req, res) => {
  try {
    console.info("Method CheckUsername");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post(
  "/apinit/RetriveTestsBystudentId_code",
  async (req, res) => {
    try {
...
serverV9router.post(
  "/apinit/RetriveProgramQuestionsByTestid",
  async (req, res) => {
    try {
      console.info("listofTests");
      await sql.connect(sqlConfig);
...
serverV9router.post("/apinit/RetriveProgramsByStudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/RetriveTestsBystudentId_Mcq", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.get(
  "/apinit/retrive-batch-details/:batchId",
  async (req, res) => {
    try {
...
serverV9router.post("/apinit/program/new-program", (req, res) => {
  try {
    const body = req.body;
...
serverV9router.get("/apinit/ExamMainPage", async (req, res) => {
  const testID = req.query.testID; // Extract testID from query string
  const transactionId = req.query.transactionId;
  const userName = req.query.UserName;
...
serverV9router.get("/apinit/studentexampagev1", async (req, res) => {
...
serverV9router.get("/apinit/studentExamPagemodified", async (req, res) => {
...
serverV9router.get("/apinit/login", async (req, res) => {
...
//serverV9router.get('/studentResultPage', async (req, res) => {
...
//serverV9router.get('/ ', async (req, res) => {
//    try {
...
serverV9router.post("/studentResults", async (req, res) => {
  try {
...
serverV9router.post("/apinit/StudentProgramTestCases", async (req, res) => {
  try {
...
serverV9router.post("/apinit/RetriveTestsBystudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
serverV9router.post("/apinit/RetriveProgramResults", async (req, res) => {
  try {
...
serverV9router.get("/apinit/studentResultPageview", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
serverV9router.get("/apinit/fetchAndShowResults", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
serverV9router.get("/apinit/FetchProgramsByTechnologies", async (req, res) => {
  try {
    console.info("List of  Programs");
    await sql.connect(sqlConfig);
...
// Start Server
// serverV9router.listen(PORT, () => {
//   console.log(`Server is running on port ${PORT}`);
// });
serverV9router.post("/apinit/executeonline", async (req, res) => {
...
serverV9router.get("/apinit/fetchProgramLanguages", async (req, res) => {
  try {
    console.info("List of Technolgies");
    await sql.connect(sqlConfig);
...
serverV9router.get(
  "/apinit/fetch_StudentNames_StudentReportData",
  async (req, res) => {
    try {
...
serverV9router.get(
  "/apinit/fetch_TechnologyName_StudentReportData",
  async (req, res) => {
    try {
...
serverV9router.get("/get_StudentReport/:username", async (req, res) => {
  try {
    console.info("List of StudentNames");
    await sql.connect(sqlConfig);
...
serverV9router.get("/studentReport_Technology", async (req, res) => {
  try {
    console.info("List of StudentNames");
    await sql.connect(sqlConfig);
    const {
...
serverV9router.get("/get_StudentReport_module", async (req, res) => {
  try {
...
serverV9router.get("/get_StudentReport_Topic", async (req, res) => {
  try {
...
serverV9router.post(
  "/apinit/InsertUpdateDelete_ProgramsQuestions",
  async (req, res) => {
    try {
      console.info("Method Insert Questions");
      await sql.connect(sqlConfig);
...
serverV9router.get("/apinit/FetchTestcasesByProgramID", async (req, res) => {
  try {
...
serverV9router.post(
  "/apinit/InsertUpdate_ProgramTestCases",
  async (req, res) => {
    try {
...
serverV9router.delete("/apinit/Delete_ProgramTestCases", async (req, res) => {
  try {
...
serverV9router.get("/apinit/onlineCodeEditor", (req, res) => {
  // Replace testCasesData with your actual test cases data
  res.render("VirtualLab", { testCases: testCasesData });
});
serverV9router.get("/apinit/CodeEditor", (req, res) => {
  console.log("page request reached");
  // Replace testCasesData with your actual test cases data
  res.render("CodeEditor");
});
serverV9router.post("/apinit/executeCodeOnline", async (req, res) => {
  const code = req.body.code;
  try {
    const output = await executeCodeOnline(code);
...
// serverV9router.get("/getcurriculamdetails", async (req, res) => {
...
serverV9router.get("/apinit/fetchbatchesByTechnologyId", async (req, res) => {
  try {
...
serverV9router.get("/apinit/fetchModulesByTechnologyId", async (req, res) => {
  try {
...
serverV9router.get("/apinit/fetchTopicsByModuleId", async (req, res) => {
  try {
...
serverV9router.get("/api/fetchstudentsByBatchId", async (req, res) => {
  try {
    console.info("List of Topics");
    await sql.connect(sqlConfig);
    console.log(req.Query);
...
serverV9router.post("/api/submitAssessmentDetails", async (req, res) => {
  try {
    console.info("listofProgramTestcases");
...
serverV9router.get("/api/fetchBatchIdByFacultyId", async (req, res) => {
  let pool;
  try {
    ...
    // Ensure the pool is closed only after all queries have been processed
    if (pool) {
      try {
        await pool.close(); // Close the pool only when all operations are done
      } catch (closeErr) {
        console.error("Error closing the SQL pool", closeErr);
      }
    }
  }
});
...
serverV9router.post(
  "/api/insertUpdateStudentWeeklyCalender",
  async (req, res) => {
    try {
...
serverV9router.put("/api/UpdateStudentWeeklyCalender", async (req, res) => {
  try {
...
serverV9router.get("/api/retrieveAvailableSlots", async (req, res) => {
  try {
...
serverV9router.get(
  "/api/retrieStudentCalenderforAdminApproval",
  async (req, res) => {
    try {
      console.log("Fetching available slots");
...
serverV9router.get(
  "/api/retriveStudentCalenderByStudentId",
  async (req, res) => {
    try {
...
serverV9router.put("/apinit/updateMock_TestStatus", async (req, res) => {
  try {
    console.info("Update status");
    await sql.connect(sqlConfig);
...
serverV9router.get("/api/fetchTopicsByFacultyId", async (req, res) => {
  try {
...
serverV9router.get("/api/FetchSubtopicsByTopicId", async (req, res) => {
  try {
...
serverV9router.get("/api/getModulesByFacultyId", async (req, res) => {
  try {
...
serverV9router.get("/api/retriveRegisteredUser", async (req, res) => {
  try {
...
serverV9router.get("/api/validateUserExist", async (req, res) => {
  try {
    await sql.connect(sqlConfig);
...
serverV9router.put(
  "/apinit/UpdateAndDeleteUserAssignBatches",
  async (req, res) => {
    try {
...
serverV9router.put(
  "/apinit/upadteAndDeleteUserRegistration",
  async (req, res) => {
    try {
    ...
    @experience=${experience},@mode=${mode},@TechnologyId=${TechnologyId},@userId=${userId},@type=${type},@action=${action}`;
      ...
      try {
        ...
        console.error("Error closing the SQL connection:", err);
      }
    }
  }
);

serverV9router.put("/apinit/verifyPassword", async (req, res) => {
  try {
...
serverV9router.get(
  "/api/fetFacultyInterviewerAdminMentor",
  async (req, res) => {
    try {
      console.info("List of Topics");
      await sql.connect(sqlConfig);
...
serverV9router.get(
  "/api/fetchTechnologiesFacultyMentorInterviewer",
  async (req, res) => {
    try {
      console.info(
      ...
      // Ensure the SQL connection is closed after each request
      await sql.close();
    }
  }
);

serverV9router.get("/api/fetchBatchesByTechnologyid", async (req, res) => {
  try {
...
serverV9router.post(
  "/api/inserUpdateFacultyMentorBatchMapping",
  async (req, res) => {
    try {
...
serverV9router.get("/apinit/fetchModulesByMentorId", async (req, res) => {
  try {
    console.info("List of  Modules");
    await sql.connect(sqlConfig);
    console.log(req.query);
...
serverV9router.post(
  "/apinit/insertCurriculumForStudentCalender",
  async (req, res) => {
    try {
...
serverV9router.put("/apinit/updateStudentCalenderSlots", async (req, res) => {
  try {
...
serverV9router.put("/apinit/getDatesForStudentCalender", async (req, res) => {
  try {
...
serverV9router.put("/apinit/updateStudentMarks", async (req, res) => {
  try {
...
serverV9router.post("/apinit/insertUpdateMocktest", async (req, res) => {
  try {
...
serverV9router.get("/apinit/GetStudentObtainMarks", async (req, res) => {
  try {
...
serverV9router.get(
  "/apinit/getStatrtDateFormock_descriptiveTests",
  async (req, res) => {
    try {
...
serverV9router.get("/api/getModulesByTestidForMock", async (req, res) => {
  try {
    console.log("Fetching subtopics");
...
serverV9router.get("/api/getTopicsByTestidForMock", async (req, res) => {
  try {
    console.log("Fetching subtopics");
...
serverV9router.get("/api/nit/fetchMocktestDetails", async (req, res) => {
  try {
...
serverV9router.post("/insertfacultycurriculam", async (req, res) => {
  const {
    facultyId,
...
module.exports = serverV9router;
// export default serverV9router;
