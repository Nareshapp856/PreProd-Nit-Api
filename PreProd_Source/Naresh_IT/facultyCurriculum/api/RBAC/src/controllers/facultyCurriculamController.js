...
exports.fetchAssignedCurriculumList = async (req, res) => {
  try {
    ...
    const _query = `
     select fc.curriculam_Id,fc.courseCurriculam_Name,b.BatchName,a.TestStartDate,a.TestEndDate,a.TestStartTime,a.TestEndTime,a.status,a.assessmentID from Assessment_v1 a
...
select b.batchid,a.TestStartDate,a.TestEndDate,a.TestStartTime,a.TestEndTime,fc.courseCurriculam_Name,a.assessmentId from  facultyCourse_curriculum fc
inner join assessment_v1 a
on fc.courseCurriculam_Name=a.testdescription
inner join BatchDetailes b
on a.BatchId=b.BatchId
