...
router.get("/register-2fa", async (req, res) => {
...
router.get("/checkUserAvailability", async (req, res) => {
  try {
...
//});
router.post("/testcreatortypes", async (req, res) => {
  try {
...
router.get("/testSelection", (req, res) => {
  res.render("TestSelection", {
    /* Add any variables you want to pass to the view */
  });
});

router.get("/testcreator", (req, res) => {
  res.render("testcreator", {
    /* Add any variables you want to pass to the view */
  });
});

router.get("/testcreatortypes", (req, res) => {
...
router.get("/NITReports", async (req, res) => {
  try {
...
router.get("/RetriveResultPage", (req, res) => {
...
router.get("/testCreationPage", (req, res) => {
  res.render("testCreationPage");
});
router.get("/quesitontreeview", async (req, res) => {
  try {
...
router.get("/questionSelection", (req, res) => {
...
router.get("/fetchEnrollModules/:technologyId", async (req, res) => {
  try {
    console.info("List of  Technologies");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/api/getQuestionCounts/:questionTypeId", async (req, res) => {
  try {
    const testId = 1;
...
router.post("/InsertionQuestionView", async (req, res) => {
  try {
...
router.post("/Listof_BatchDetails", async (req, res) => {
  try {
...
router.post("/CreateNewEnrollId", async (req, res) => {
  try {
...
router.post("/Listof_AvailableTests", async (req, res) => {
  try {
...
router.post("/Fetch_StudentEmail", async (req, res) => {
  try {
...
router.post("/FetchTechnologyBy_Email", async (req, res) => {
  try {
    console.info("Method CheckEmail");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/GetBatchesByTestId", async (req, res) => {
  try {
...
router.post("/GetStudentNameByBatchId", async (req, res) => {
  try {
...
router.post("/Retrive_SlotDetails", async (req, res) => {
  try {
...
router.post("/Retrive_SlotDetails_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/Update_BookSlot", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/Update_BookSlot_V1", async (req, res) => {
  try {
    console.info("Method listofSlots");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/UserLogin_send-otp", async (req, res) => {
...
router.post("/GetBatchIdsByTestids", async (req, res) => {
  try {
...
router.post("/EnrollTest", async (req, res) => {
  try {
...
router.delete("/DeleteEnrollmentId", async (req, res) => {
  try {
...
router.post("/Retrive_Enroll", async (req, res) => {
  try {
...
router.post("/Fetch_Batches", async (req, res) => {
  try {
    console.info("Method ListofBatches");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/Create_StudentsBatchs", async (req, res) => {
  try {
    ...
    res.status(200).send("Batch updated successfully.");
  } catch (error) {
    console.error("Error:", error.message);
    res.status(500).send("Internal Server Error");
  }
...
router.post("/Get_Facaulty", async (req, res) => {
  try {
...
router.post("/Get_Mentors", async (req, res) => {
  try {
    console.info("Method Listof_Facaulty");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/ListofStudents", async (req, res) => {
  try {
    console.info("Method listofStudents");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/CreateDynamicTest", async (req, res) => {
  try {
...
router.post("/Insert_Update_QuestionCombination", async (req, res) => {
  try {
...
router.post("/Insertion_StudentProgramDeatils", async (req, res) => {
  try {
    console.info("Method Listof_Facaulty");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/SelectQuestionCombination", async (req, res) => {
  try {
...
router.post("/FetchAvailableQuestionsByCount", async (req, res) => {
  try {
...
router.post("/Final_Preview", async (req, res) => {
  try {
...
router.post("/SelectAllFixedQuestions", async (req, res) => {
  try {
...
router.post("/RetriveTestSchedule", async (req, res) => {
  try {
...
router.post("/LoadStudentData", async (req, res) => {
  try {
...
router.post("/CreateTechnology", async (req, res) => {
  try {
...
router.put("/UpdateTechnology", async (req, res) => {
  try {
...
router.post("/GetTechnologyID", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/DeleteTechnology", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/SelectAll_Technologies", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/SelectValuesBy_TechnologyID", async (req, res) => {
  try {
    console.info("Method entered for update technology");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.delete("/Delete_Module", async (req, res) => {
  try {
    console.info("Method entered for update Module");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/CreateTopics", async (req, res) => {
  try {
...
router.post("/CreateSubTopic", async (req, res) => {
  try {
...
router.post("/CreateMCQquestions", async (req, res) => {
  try {
...
router.post("/FinalSubmission", async (req, res) => {
  try {
...
router.post("/RefreshSubmission", async (req, res) => {
  try {
    // Extract data from the request body
    const resultData = req.body.resultData;
    const studentName = req.body.studentName;
...
router.post("/getCurrentQuestionId", async (req, res) => {
  try {
...
router.post("/UpdateCombinations", async (req, res) => {
  try {
...
router.put("/updateCurrentQuestionId", async (req, res) => {
  try {
...
router.post("/createEditTest", async (req, res) => {
  try {
...
router.post("/getBasicTestInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
...
router.post("/getBasicTestDetailsInfo", async (req, res) => {
  try {
    console.log(req.body.data.TestID);
    const pool = await sql.connect(sqlConfig);
    const result = await pool.request();
...
router.post("/createTestAssessment", async (req, res) => {
  try {
    console.log(req.body.data);
    const pool = await sql.connect(sqlConfig);
    const result = await pool
...
router.post("/CreateTestQuestions", async (req, res) => {
  try {
    const table = new sql.Table();
...
router.post("/insertQuestionData", async (req, res) => {
  try {
...
router.post("/FastTrackCreateTest", async (req, res) => {
  try {
    const questionData = req.body;
...
router.get("/fetchFixedQuestions", async (req, res) => {
  try {
...
router.get("/fetchFixedProgrammQuestions", async (req, res) => {
  try {
...
router.get("/retrieveProgramQuestions/:id", async (req, res) => {
  try {
...
router.get("/retrieveProgramTestCase/:id", async (req, res) => {
  try {
...
router.get("/mcqCheckQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
...
router.get("/FreeTextQuestions", async (req, res) => {
  try {
    // Extract easy, medium, and hard counts from query parameters
    const { easyCount, mediumCount, hardCount } = req.query;
...
router.get("/fetchtestsbydate", async (req, res) => {
  try {
...
router.get("/studentExamPage", async (req, res) => {
...
router.get("/previewExamPage", async (req, res) => {
...
router.post("/RetriveTestsBystudentId_code", async (req, res) => {
  try {
...
router.post("/RetriveProgramsByStudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/RetriveTestsBystudentId_Mcq", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/retrive-batch-details/:batchId", async (req, res) => {
  try {
...
router.post("/api/program/new-program", (req, res) => {
  try {
    const body = req.body;
...
router.get("/ExamMainPage", async (req, res) => {
  const testID = req.query.testID; // Extract testID from query string
  const transactionId = req.query.transactionId;
  const userName = req.query.UserName;
...
router.get("/studentexampagev1", async (req, res) => {
...
router.get("/studentExamPagemodified", async (req, res) => {
...
router.post("/StudentProgramTestCases", async (req, res) => {
  try {
...
router.post("/RetriveTestsBystudentId", async (req, res) => {
  try {
    console.info("listofTests");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.post("/RetriveProgramResults", async (req, res) => {
  try {
...
router.get("/studentResultPageview", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
router.get("/fetchAndShowResults", async (req, res) => {
  try {
    const { testId, studentName, transactionId } = req.query;
...
router.get("/FetchProgramsByTechnologies", async (req, res) => {
  try {
    console.info("List of  Programs");
    await sql.connect(sqlConfig);
...
router.post("/executeonline", async (req, res) => {
...
router.get("/fetchProgramLanguages", async (req, res) => {
  try {
    console.info("List of Technolgies");
    await sql.connect(sqlConfig);
...
router.get("/fetch_StudentNames_StudentReportData", async (req, res) => {
  try {
...
router.get("/fetch_TechnologyName_StudentReportData", async (req, res) => {
  try {
...
router.post("/InsertUpdateDelete_ProgramsQuestions", async (req, res) => {
  try {
    console.info("Method Insert Questions");
    await sql.connect(sqlConfig);
    console.log(req.body);
...
router.get("/FetchTestcasesByProgramID", async (req, res) => {
  try {
...
router.post("/InsertUpdate_ProgramTestCases", async (req, res) => {
  try {
...
router.delete(
  "/DeleteProgramquestionsBy_ProgramId/:programId",
  async (req, res) => {
    try {
...
router.delete("/Delete_ProgramTestCases", async (req, res) => {
  try {
...
router.get("/onlineCodeEditor", (req, res) => {
...
router.post("/executeCodeOnline", async (req, res) => {
  const code = req.body.code;
  try {
    const output = await executeCodeOnline(code);
