...
import Profile from "./mockInterviewersidenav/Profile";
...
function FacultySideNav() {
  ...
  const mockInterviewer = () => {
    navigate("/mockinterviewer/evolution-sheet");
  };
    ...
    >
      ...
      <MenuList>
        ...
        <MenuItem
          ...
          onClick={(e) => handleNavClick(e, mockInterviewer)}
        >
          <List sx={{ paddingBlock: 0, marginBlock: 0.4 }} className="w-full">
            <ListItem
              style={{
                backgroundColor:
                  location.pathname === "/mockinterviewer/evolution-sheet"
                    ? "rgba(30,64,175,.20)"
                    : null,
              }}
              className="rounded"
            >
              ...
              <ListItemText primary="Evolution Sheet" />
            </ListItem>
          </List>
        </MenuItem>
      </MenuList>
