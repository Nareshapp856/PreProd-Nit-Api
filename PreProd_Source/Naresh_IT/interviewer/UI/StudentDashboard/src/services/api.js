...
export async function submitAddInterviewerAPI(payload) {
  try {
    const res = await facultyAPI.post(
      `api/interviewer/insert-interviewerbatches`,
      payload
    );
...
export async function fetchTechnologiesAPI(payload) {
  try {
    const res = await api.get(`/apinit/fetchTechnologies`, payload);
...
export async function fetchBatchesAPI(payload) {
  let url = `api/interviewer/fetch-batches`;

  try {
    if (payload) url += `?techId=${payload}`;
    const res = await facultyAPI.get(url, payload);
...
export async function fetchInterviewersAPI(payload) {
  let url = `api/interviewer/fetch-interviewers`;
...
export async function fetchBatchesByInterviewerIdAPI(payload) {
  let url = `api/interviewer/fetch-batches/${payload}`;

  try {
    if (!payload) throw new Error("Not A Valid API Call.");
...
export async function fetchStudentsByBatchIdAPI(payload) {
  let url = `api/interviewer/fetch-students/${payload}`;
...
export async function fetchModulesByInterviewerIdAPI(payload) {
  let url = `api/interviewer/fetch-modules/${payload}`;
...
export const fetchTopicAPI = async (payload) => {
  try {
    const response = await facultyAPI.post(
      `api/interviewer/topicsbymodules`,
      payload
    );
...
export const fetchInterviewersAndBatchesAPI = async (payload) => {
  try {
    const response = await facultyAPI.get(
      `api/interviewer/fetchinterviewersandbatches`,
      payload
    );
...
export const deleteInterviewerBatchesComboAPI = async (payload) => {
  try {
    if (!payload) throw new Error("Must pass valid data to call api");

    const response = await facultyAPI.delete(
      `api/interviewer/mappedinterviewerbatches/${payload}`,
      payload
    );
