...
import {
  registerInterviewerSlice,
  submitEvolutionSheetSlice,
} from "./user/interviewer";
...
export const rootReducer = combineReducers({
  ...
  registerInterviewer: registerInterviewerSlice.reducer,
  ...
  // Interviewer
  submitEvolutionSheet: submitEvolutionSheetSlice.reducer,
});
