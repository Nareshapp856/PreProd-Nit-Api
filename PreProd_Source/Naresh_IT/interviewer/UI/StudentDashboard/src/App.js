...
import InitialPasswordUpdate from "./pages/auth/InitialPasswordUpdate";
...
import RegisterInterviewer from "./pages/admin/main/RegisterInterviewer";
import MockInterviewer from "./pages/mockInterviewer/HomePage";
import EvolutionSheetPage from "./pages/mockInterviewer/main/EvolutionSheet";
import AddInterviewer from "./pages/admin/main/AddInterviewer";
  ...
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      element: (
        <PrivateRoute
          element={Admin}
          allowedRoles={["faculty", "admin", "interviewer"]}
      ...
      children: [
        ...
        { path: "add-interviewer", element: <AddInterviewer /> },
        { path: "interviewer-registration", element: <RegisterInterviewer /> },
      ],
    },
    {
      path: "/mockinterviewer",
      element: (
        <PrivateRoute
          element={MockInterviewer}
          allowedRoles={["faculty", "admin", "interviewer"]}
          exceptions={["satyanarayanakrv111@gmail.com"]}
        />
      ),
      children: [{ path: "evolution-sheet", element: <EvolutionSheetPage /> }],
    },
    {
      path: "/",
