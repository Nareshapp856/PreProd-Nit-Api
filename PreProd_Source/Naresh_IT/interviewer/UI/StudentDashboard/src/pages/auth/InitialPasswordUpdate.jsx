...
import ResetPasswordForm from "../../components/auth/initialPasswordUpdate/InitialPasswordUpdate";

function InitialPasswordUpdate() {
  return (
    <>
...
export default InitialPasswordUpdate;
