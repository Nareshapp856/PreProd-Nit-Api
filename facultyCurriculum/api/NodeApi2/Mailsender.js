...
function mailsend(userid = 10, Name = "Gangadhar") {
  ...
  const mailOptions = {
    ...
    to: "gangadharpola9182@gmail.com",
    bcc: userid,
    subject: ` Welcome to NareshIT ERP – Your Gateway to Learning and Growth!`,

    text: `Dear ${Name}

        Welcome to NareshIT! We are thrilled to have you as part of our learning community. 
        We take great pride in providing quality IT training and skill development, and we are excited to be a part of your learning journey.

        At NareshIT, we believe in providing a seamless learning experience, and to support your progress, we have developed a dedicated ERP platform that will empower you to manage your learning more effectively. 
        ...
        We hope you make the most of your time with us, and we are confident that our platform, combined with our expert trainers and innovative courses, 
        will help you achieve your professional goals.
        Should you have any questions or need assistance, feel free to reach out to our support team at [Support Email] or [Support Phone Number].
