...
const ModuleGraphComponent = ({
  ...
  const onClick = (moduleName, e) => {
    if (moduleName === "total" || moduleName === "Average") return;
  ...
  // Function to round the percentage to 2 decimal places
    ...
    <div>
      <ResponsiveContainer width="100%" height={350}>
        ...
        >
          ...
          <YAxis
            domain={[0, 100]}
            tickFormatter={(tick) => `${roundToTwoDecimalPlaces(tick)}%`} // Round percentage on Y-Axis
          />
          <Tooltip
